...
![GitHub release (latest by date)](https://img.shields.io/github/v/release/navikt/fp-tidsserie.svg?style=for-the-badge&logo=apache-maven&link=)
...
```        
		<dependency>
			...
			<version>2.1-20200122111234-8f9c988</version>
		</dependency>
```
