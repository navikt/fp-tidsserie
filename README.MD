...
Fom/tom (fra-og-med, til-og-med) er valgt ettersom det er datoer som manipuleres og det er dermed mindre sjanse for forvirring om sluttdatoer. 
...
Dette er ikke synlig for bruker av API'et, men kan gi problemer med må modellere datoer etter år 9999, eller før -4999.

Implementasjonen er uavhengig av hvilken type verdi <V> har, men brukeren av biblioteker kan selv bestemme dette.
...
### compress
eturnerer ny tiddsserie der tilliggende intervaller med samme verdi er slått sammen.
### combine
Kombinerer to tidsserier T(a) og T(b) til en ny tidsserie T(c), der a, b, og c kan være forskjellig typer java objekter. 
Intervaller i en tidsserie kombineres ihenhold til angitt "JoinStyle" som angir om det er intersection eller noe annen form for kombinering. 
...
Hvorvidt tomme intervaller, eller andre måter å kombinere tidsserienen på kan angis ved parametere.
